...
export const apps = [
  ...
  { slug: 'bloon-boon',             title: 'Bloon Boon',             blurb: 'A shader-balloon juggling game — tap and flick glossy 3D balloons to keep them aloft; each color sings its own sound.', entry: 'index.html' },
