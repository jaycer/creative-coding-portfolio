...
export const apps = [
  ...
  { slug: 'chairs-in-space',        title: 'Chairs in Space',        blurb: 'The same plain chairs, but adrift in zero gravity — tumbling through a starfield past a hazy planet. Tap or press any key to send another one out.', entry: 'index.html' },
