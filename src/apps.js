...
export const apps = [
  ...
  { slug: 'pantry',                 title: 'Cleveland Food Finder',  blurb: 'A filterable directory of ~370 free food sources around Cleveland, cleansed from Greater Cleveland Food Bank data. Filter by area, day, and the city you live in; eligibility shown upfront; export a printable full-pager or a fold-up booklet.', entry: 'index.html' },
